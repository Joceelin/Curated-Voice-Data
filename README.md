...
To prevent pervasive background terminology from dominating frequency distributions and obscuring thematic variations, the clean-up script filters out standard English stop words along with specific domain-level keywords.
